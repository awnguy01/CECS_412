...
.global hAddress      //high address bit
.global lAddress      //low address bit
.global content       //content to be written to eeprom
...
EEPROM_Write:      
      ...
      lds     r18,hAddress    ; Set up address (r18:r17) in address register
      lds     r17,lAddress 
...
EEPROM_Read:					    
      ...
      lds     r18,hAddress    ; Set up address (r18:r17) in EEPROM address register
      lds     r17,lAddress
      ldi     r16,0x00   
      out     EEARH, r18   
      out     EEARL, r17		   
